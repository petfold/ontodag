...
PACK = (
    ...
    ('cephaloglycin', ('antibacterial',)),
    ('cephaloridine', ('antibacterial',)),
    ...
    ('dihydrostreptomycin', ('antibacterial',)),
    ...
    ('gramicidin', ('antibacterial', 'antiseptic', 'chemical')),
    ('graze', ('abrasion',)),
    ...
    ('kaliuresis', ('symptom',)),
    ('kanamycin', ('antibacterial', 'chemical')),
    ...
    ('natriuresis', ('symptom',)),
    ('neomycin', ('antibacterial', 'antiseptic')),
    ...
    ('pyocyanase', ('antibacterial',)),
    ('pyocyanin', ('antibacterial',)),
    ('pyuria', ('symptom',)),
    ('quack', ('wrongdoer',)),
    ...
    ('tyrocidine', ('antibacterial',)),
    ('tyrosine-kinase-inhibitor', ('medication',)),
    ('tyrothricin', ('antibacterial',)),
