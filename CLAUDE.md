...
Done 2026-07-25 (were items 1–2 of this list): the recordstore requirement is `>=0.11` with 0.11.0 installed and `docs/recordstore-interface.md` re-synced against it; `SwarmOntoDAG._hydrate` now batches through `RecordStore.items()`.
