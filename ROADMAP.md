...
[HOW_IT_WORKS.md](docs/HOW_IT_WORKS.md), whose section numbers (§2 canonical form, §4
...
([CONTRACT.md](docs/CONTRACT.md)), verifiable answers, and provenance-gated agent
writes ([PROVENANCE.md](docs/PROVENANCE.md)) — while keeping a decent human
...
12. **OntoDAG in a browser, on Swarm.** Two things landed on 2026-08-02
    ...
    demonstrate and in what order, in [BROWSER.md](docs/plans/BROWSER.md). Blocked on
...
- **Learned categories.** A companion project, `mdl-fca`, learns "good" category
  ...
  *Note 2026-08-01: the provenance machinery itself is no longer horizon — it
  moved to the queue ([PROVENANCE.md](docs/PROVENANCE.md)) because agent writes
